        ...
        commandDispatcher_1.register(
                CommandManager.literal("event")
                        ...
                        .then(CommandManager.literal("run")
                                .then(CommandManager.argument("name", new FunctionAPIIdentifierArgumentType())
                                        .suggests(SUGGESTION_PROVIDER)
                                        .executes((commandContext) -> {
                                            try {
                                                ServerCommandSource commandSource = commandContext.getSource();
                                                FunctionManager<ServerCommandSource, MinecraftServer> manager = GlobalEventContainer.getInstance().getManager(commandContext.getArgument("name", FunctionAPIIdentifier.class));
                        ...
                        .then(CommandManager.literal("enable")
                                ...
                                .then(CommandManager.argument("name", new FunctionAPIIdentifierArgumentType())
                                        .suggests(SUGGESTION_PROVIDER)
                                        .executes((commandContext) -> {
                                            FunctionAPIIdentifier name = commandContext.getArgument("name", FunctionAPIIdentifier.class);
                                ...
                                .then(CommandManager.argument("target name", new IdentifierArgumentType())
                                        .then(CommandManager.argument("eventName", StringArgumentType.word())
                                                .executes((commandContext_1) -> {
                                                    FunctionAPIIdentifier group = commandContext_1.getArgument("target name", FunctionAPIIdentifier.class);
                                                    ...
                                                    FunctionManager<ServerCommandSource, MinecraftServer> manager = GlobalEventContainer.getInstance().getManager(eventManager.getID());
