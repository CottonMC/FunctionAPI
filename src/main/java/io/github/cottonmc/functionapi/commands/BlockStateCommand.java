...
public class BlockStateCommand {
    ...
    private static ArgumentBuilder<ServerCommandSource, LiteralArgumentBuilder<ServerCommandSource>> directionArgument(CommandWithArgument<Direction> command) {
    ...
    private static ArgumentBuilder<ServerCommandSource, LiteralArgumentBuilder<ServerCommandSource>> slabArgument(CommandWithArgument<SlabType> command) {
