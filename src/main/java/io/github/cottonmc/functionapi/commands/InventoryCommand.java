...
public class InventoryCommand {
    ...
    private static ArgumentBuilder<ServerCommandSource, LiteralArgumentBuilder<ServerCommandSource>> buildSourceEntityMoveArgument(BiDirectionalCommand command) {
