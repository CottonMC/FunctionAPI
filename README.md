...
| namespace:function_api/item/name/use_on_block                   | called after the item was used on a block                                         | called in the name of the user, in the block's position                                                                                                                                                                           |
| namespace:function_api/item/name/use_on_entiy                   | called after the item was used on an entity                                       | called in the name of the entity, in it's position                                                                                                                                                                                |
...
| namespace:function_api/entity/name/on_attacking                 | called when the entity is attacking something                                     | called in the name of the entity, in it's position                                                                                                                                                                                |
| namespace:function_api/entity/name/on_death                     | called when the entity dies                                                       | called in the entity's position. No entity is in the context, as it might not exist anymore.                                                                                                                                      |
...
be called by the `event` command.
